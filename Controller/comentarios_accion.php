...
function getAllComments()
{
    ...
    $queryComments = "SELECT * FROM comentarios_accion";
...
{
    $db = Conexion::getConnection();
    $queryComment = "SELECT * FROM comentarios_accion WHERE id=" . $id;
...
function updateOneComment($id, $nombre, $comentario)
{
    $db = Conexion::getConnection();
    //crear variable para hacer consultas SQL
    $queryComments = "UPDATE comentarios_accion SET nombre ='$nombre', comentario ='$comentario' WHERE id=" . $id;
...
function deleteOneComment($id)
{
    $db = Conexion::getConnection();
    //crear variable para hacer consultas SQL
    $queryComments = "DELETE FROM comentarios_accion WHERE id=" . $id;
    //echo $queryComments;
    $db->query($queryComments);
}
if (isset($_GET["elimina"]) && isset($_GET["id"])) {
    deleteOneComment($_GET["id"]);
    header("Location:".SECTION_PATH."accion.php");
}
...
function newComment($nombre, $comentario)
{
    $db = Conexion::getConnection();
    //crear variable para hacer consultas SQL
    $queryComments = "INSERT INTO comentarios_accion (nombre, comentario) VALUES ('$nombre', '$comentario')";
    //echo $queryComments;
    $db->query($queryComments);
}
